...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    m_robotContainer.getFrontLimelight().setPipelineCommand(LimelightPipeline.SHOOT);
    m_robotContainer.getRearLimelight().setPipelineCommand(LimelightPipeline.SHOOT);
